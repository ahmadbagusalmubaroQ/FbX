...
pu='\033[37;1m' #putih
ku='\033[33;1m' #kuning
# [follow my IG] ahmadbagusalmubaroq
figlet -f standard FBX Tools | lolcat
echo
echo  " ____________________-=[Private Tools]=-____________________" | lolcat
echo  "|                                                           |" | lolcat
echo  "|              Root®Autor      : Gus........!               |" | lolcat
echo  "|              Youtube         :AhmadBagusAlmubaroQ         |" | lolcat
echo  "|              Blog            : Gus.............!!!        |" | lolcat
...
echo $i"========================================"
echo
echo $me"┌==="$bi"["$i"GEBANGKIIDIW"$bi"]"$me"======"$bi"["$i""Masukan Nomor""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"Youtube :"$i" Gebang Kiidiw"
echo $ku"Blog    :"$i" www.abangjoss.com"
echo $ku"Instagram :"$i" @abang_joss24"
sleep 2
